...
static bool u64_u32_intersection(u64 umin, u64 umax, u32 u32_min, u32 u32_max)
{
	...
	if ((u32)umin <= (u32)umax)
		return !(((u32)umax < u32_min) || (u32_max < (u32)umin));
	else
		return !(((u32)umin > u32_max) && ((u32)umax < u32_min));
}
...
static bool u64_s32_intersection(u64 umin, u64 umax, s32 s32_min, s32 s32_max)
{
	...
	if ((s32)umin <= (s32)umax)
		return !(((s32)umax < s32_min) || (s32_max < (s32)umin));
	else
		return !(((s32)umin > s32_max) && ((s32)umax < s32_min));
}
...
static bool u32_s64_intersection(u32 u32_min, u32 u32_max, s64 smin, s64 smax)
{
	...
	if ((u32)smin <= (u32)smax)
		return !(((u32)smax < u32_min) || (u32_max < (u32)smin));
	else
		return !(((u32)smin > u32_max) && ((u32)smax < u32_min));
}
...
static bool s64_s32_intersection(s64 smin, s64 smax, s32 s32_min, s32 s32_max)
{
	...
	if ((s32)smin <= (s32)smax)
		return !(((s32)smax < s32_min) || (s32_max < (s32)smin));
	else
		return !(((s32)smin > s32_max) && ((s32)smax < s32_min));
}
